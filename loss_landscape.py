...
model_files = ['logs/dsads/icarl/weights/fcnet_noq_accbits_8_1994.npy', 'logs/dsads/icarl/weights/fcnet_ours_accbits_8_1994.npy', 'logs/dsads/icarl/weights/fcnet_luq_corrected_accbits_8_1994.npy']
...
plt.tight_layout()
plt.savefig(f"figures/ll_task_{task_to_display}.svg", dpi=300, bbox_inches="tight")
plt.close()
