...
# echo '-----------------------base'
# for i in 42467 88801 91280 01056 27534; do cat logs/bic_cifar_fp130_${i}.txt | grep -a 'CNN top1 curve' | tail -1 | grep -o -P 'curve: \[.{0,80}' | sed 's/curve//' | sed 's/\: \[//' | sed 's/\]//'; done