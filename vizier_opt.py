...
study = clients.Study.from_study_config(study_config, owner='cschaef6', study_id='hyperP')
...
for i in range(100):
  ...
  for suggestion in suggestions:
    ...
    bashCommand = "qsub -o " +  ' vizier_quant_cont/' +  res_dict[suggestion._id]['uuid'] + '.log' + " -e " +  ' vizier_quant_cont/' +  res_dict[suggestion._id]['uuid'] + '.err' + " run_mnist.script " + str(params['lr']) + ' ' + str(params['init_dyn_scale']) + ' ' + str(params['dyn_scale']) + ' ' + str(params['quantile']) + ' vizier_quant_cont/' +  res_dict[suggestion._id]['uuid'] + '.txt'
