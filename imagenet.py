...
parser.add_argument('--quantBWDGrad2', '-qbwdg2', type=str, default="int",
                    required=False, choices=['stoch', 'sq', 'int', 'noq'])
parser.add_argument('--init_dyn_scale', type=float, default=1.5)
parser.add_argument('--dyn_scale', type=float, default=1.5)
...
def main_worker(gpu, ngpus_per_node, args):
  ...
  quant.place_quant(model, None, None)
